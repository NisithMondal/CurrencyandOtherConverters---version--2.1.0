...
public class DecimalNumberSystemKeypadHandeler {
    ...
    public DecimalNumberSystemKeypadHandeler(AppCompatActivity appCompatActivity, EditText numberSystemValueEditText){
        ...
        view = layoutInflater.inflate(R.layout.decimal_number_keypad_layout,null,false);
